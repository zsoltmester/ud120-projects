...
### exercised_stock_options range
exercised_stock_options = []
for data in data_dict:
    exercised_stock_options.append(data_dict[data]['exercised_stock_options'])

exercised_stock_options = [i for i in exercised_stock_options if str(i) != 'NaN']
...
salary = []
for data in data_dict:
    salary.append(data_dict[data]['salary'])

salary = [i for i in salary if str(i) != 'NaN']
